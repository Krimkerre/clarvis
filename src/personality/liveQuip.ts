...
export function completionQuipPrompt(task: string, summary: string): string {
  return [
    ...
    '- It is an aside, not a summary. Do not restate what you did, and do not name the thing you changed.',
    '  Bad, because it is the report again: "The comment explains what the code does, which is progress."',
    '  Good, because it is about anything else: "A file that describes itself. Next you will want one that tests itself."',
